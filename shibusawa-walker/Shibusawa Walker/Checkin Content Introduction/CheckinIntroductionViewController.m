//
//  CheckinIntroductionViewController.m
//  Shibusawa Walker
//
...
@interface CheckinIntroductionViewController ()

@end

@implementation CheckinIntroductionViewController{
...
- (void)viewDidLoad {
    ...
    //configure navigation bar & drawer
...
-(void)configureNavigationDrawer{
    ...
    [self.navigationItem setTitle:NSLocalizedString(@"checkin_content", @"")];
